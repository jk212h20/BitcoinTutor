...
related: ["concepts/cpfp.md", "concepts/cpfp-carve-out.md", "concepts/package-relay.md", "concepts/ephemeral-anchors.md", "concepts/addr-v2.md", "concepts/annex.md"]
summary: "Also covering Simplified commitments

Anchor outputs are special outputs in LN commitment transactions that are designed to allow the transaction to b"
difficulty: 3
domain: transactions
---

...
related: ["concepts/proof-of-payment.md", "entities/taproot.md", "concepts/package-relay.md", "concepts/payjoin.md"]
summary: "Pay-to-contract protocols allow a spender and a receiver to agree on the text of a contract (or anything else) and then create a public key that commi"
difficulty: 2
domain: transactions
---

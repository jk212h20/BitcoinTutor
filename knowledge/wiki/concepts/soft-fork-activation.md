...
related: ["entities/taproot.md", "entities/simplicity.md", "concepts/splicing.md"]
summary: "Also covering BIP8 and BIP9

Soft fork activation describes the moment when a Bitcoin full node begins to enforce one or more additional consensus rul"
difficulty: 5
domain: consensus
---

...
related: ["concepts/hd-key-generation.md", "concepts/free-relay.md", "concepts/generic-signmessage.md"]
summary: "Gap limits are the limits wallets set for how many addresses they’ll derive from an HD wallet without seeing any transactions related to those address"
difficulty: 2
domain: wallets
---

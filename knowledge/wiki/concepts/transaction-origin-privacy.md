...
related: ["concepts/anonymity-networks.md", "concepts/v2-p2p-transport.md", "concepts/dandelion.md", "concepts/transaction-bloom-filtering.md", "concepts/transaction-pinning.md"]
summary: "Transaction origin privacy is the ability to hide the origin of a transaction from network surveillance"
difficulty: 2
domain: network
---

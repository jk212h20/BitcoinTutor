...
related: ["concepts/pooled-mining.md", "concepts/block-explorers.md", "concepts/bls-signatures.md"]
summary: "Also covering Oblivious shares

Block withholding is an attack against pooled mining where a miner submits and receives payment for shares that are no"
difficulty: 1
domain: mining
---

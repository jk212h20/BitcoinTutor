...
related: ["concepts/uneconomical-outputs.md", "concepts/out-of-band-fees.md", "concepts/output-script-descriptors.md"]
summary: "Also covering Address reuse, Dust attacks, and Reuse avoidance

Output linking, also called address reuse, occurs when a user receives two or more pay"
difficulty: 3
domain: transactions
---

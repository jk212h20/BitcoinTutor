...
related: ["entities/taproot.md", "concepts/low-r-grinding.md", "concepts/matt.md"]
summary: "MAST is a method of using a merkle tree to store the various user-selected conditions that must be fulfilled in order for the encumbered bitcoins to b"
difficulty: 2
domain: script
---

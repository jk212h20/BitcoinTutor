...
related: ["concepts/tapscript.md", "entities/taproot.md", "concepts/consensus-cleanup-soft-fork.md", "concepts/op_checktemplateverify.md", "concepts/out-of-band-fees.md"]
summary: "OP_CODESEPARATOR is an opcode that changes what data is used when a signature commits to a script"
difficulty: 3
domain: script
---

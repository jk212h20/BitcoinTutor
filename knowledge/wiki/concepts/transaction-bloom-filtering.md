...
related: ["concepts/compact-block-filters.md", "concepts/trampoline-payments.md", "concepts/transaction-origin-privacy.md"]
summary: "Also covering BIP37 and Bloom filters

Transaction bloom filtering is a method that allows lightweight clients to limit the amount of transaction data"
difficulty: 2
domain: network
---

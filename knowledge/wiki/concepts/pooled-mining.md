...
related: ["concepts/peer-storage.md", "concepts/probabilistic-payments.md"]
summary: "Also covering Betterhash, Braidpool, Stratum, and Stratum v2

Pooled mining occurs when two or more independent miners collaborate on finding proof of"
difficulty: 4
domain: mining
---
...
2256-1.  For example, approximately 1% of the numbers will

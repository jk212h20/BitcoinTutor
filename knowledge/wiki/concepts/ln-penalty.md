...
related: ["concepts/watchtowers.md", "concepts/soft-fork-activation.md", "concepts/eltoo.md", "concepts/channel-factories.md", "concepts/discreet-log-contracts.md", "concepts/liquidity-advertisements.md", "concepts/lnurl.md"]
summary: "LN-Penalty is a state protocol that penalizes a party who publishes a past state by allowing their funds to be seized by their counterparty"
difficulty: 4
domain: lightning
---

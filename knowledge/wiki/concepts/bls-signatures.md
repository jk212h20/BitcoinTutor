...
related: ["entities/musig.md", "concepts/ptlc.md", "concepts/multisignature.md", "concepts/block-withholding.md", "concepts/channel-announcements.md"]
summary: "Boneh–Lynn–Shacham signatures (BLS signatures) are digital signatures that provide a different set of tradeoffs compared to the ECDSA and schnorr sign"
difficulty: 4
domain: cryptography
---

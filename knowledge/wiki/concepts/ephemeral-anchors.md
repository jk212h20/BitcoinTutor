...
related: ["concepts/version-3-transaction-relay.md", "concepts/package-relay.md", "concepts/fee-sponsorship.md", "concepts/anchor-outputs.md", "concepts/cpfp-carve-out.md", "concepts/eltoo.md", "entities/erlay.md"]
summary: "Also covering Pay-to-Anchor (P2A) and Ephemeral dust

Ephemeral anchors are a proposal to allow some transactions to be relayed even if they don’t pay"
difficulty: 3
domain: transactions
---

...
related: ["concepts/anonymity-networks.md", "entities/ecash.md", "concepts/eltoo.md"]
summary: "Eclipse attacks occur when a node is isolated from all honest peers but remains connected to at least one malicious peer"
difficulty: 2
domain: network
---

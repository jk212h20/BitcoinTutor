...
related: ["entities/taproot.md", "concepts/tapscript.md", "concepts/covenants.md", "concepts/mast.md", "concepts/schnorr-signatures.md", "concepts/watchtowers.md", "concepts/zero-conf-channels.md"]
summary: "X-only public keys are public keys for the secp256k1 elliptic curve that only provide the x coordinate for their position in the finite field"
difficulty: 3
domain: script
---

...
related: ["concepts/cpfp-carve-out.md", "concepts/ephemeral-anchors.md", "concepts/transaction-origin-privacy.md", "concepts/transitory-soft-forks.md"]
summary: "Transaction pinning is a method for making fee bumping prohibitively expensive by abusing node protections against attacks that can waste bandwidth, C"
difficulty: 3
domain: transactions
---

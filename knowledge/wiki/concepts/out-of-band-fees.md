...
related: ["concepts/replace-by-fee.md", "concepts/cpfp.md", "concepts/fee-sniping.md", "concepts/op_codeseparator.md", "concepts/output-linking.md"]
summary: "Out-of-band fees are payments made directly to a specific miner (or group of miners) in exchange for confirming one or more transactions"
difficulty: 3
domain: transactions
---

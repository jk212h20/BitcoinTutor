...
related: ["concepts/cpfp.md", "concepts/anchor-outputs.md", "concepts/output-script-descriptors.md", "concepts/pay-to-contract-outputs.md"]
summary: "Also covering BIP331

Package relay is a proposed feature for Bitcoin relay nodes that would allow them to send and receive packages of related transa"
difficulty: 3
domain: transactions
---

...
related: ["concepts/htlc.md", "concepts/transitory-soft-forks.md", "concepts/unannounced-channels.md"]
summary: "Trimmed HTLCs are forwardable LN payments that are below a channel’s economic limit for being resolved onchain"
difficulty: 2
domain: transactions
---

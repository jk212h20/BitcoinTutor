...
related: ["concepts/soft-fork-activation/#2016-7-bip9-bip148-and-bip91-the-bip141143-segwit-activation.md", "entities/ark.md", "entities/assumeutxo.md"]
summary: "Also covering Overt ASICBoost and Covert ASICBoost

ASICBoost is a technique for specially constructing a Bitcoin block header in order to reduce by a"
difficulty: 2
domain: mining
---

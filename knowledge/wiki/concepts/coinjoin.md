...
related: ["concepts/payjoin.md", "concepts/coin-selection.md", "concepts/coinswap.md"]
summary: "Coinjoin is a trustless protocol for mixing UTXOs from multiple owners in order to make it difficult for outside parties to use the block chain’s tran"
difficulty: 4
domain: transactions
---

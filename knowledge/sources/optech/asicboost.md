...
2021
  ...
  Question about block templates versus actual blocks: ASICBoost explains one difference


2019

  Bitcoin Core #15471 removes warning falsely triggered by use of overt ASICBoost


2018

  Overt ASICBoost support for S9 miners
...
See also
    ...
    BIP320: nVersion bits for general purpose use
...
Previous Topic:Ark protocol




Next Topic:AssumeUTXO
...
- topics ()
- controversy (soft-fork-activation/#2016-7-bip9-bip148-and-bip91-the-bip141143-segwit-activation)
- Ark protocol (ark)

...
Primary code and documentation
  ...
  Scaling Bitcoin with Inherited IDs, section 5.3: timeout-trees
  Scaling Lightning With Simple Covenants, section 4.2: timeout-trees
...
2024
  ...
  OPR protocol proposed to improve timeout tree efficiency
  Superscalar: timeout tree channel factories


2023

  Using covenants to improve LN scalability via timeout trees
  Proposal for a managed joinpool protocol (Ark)


2021

  New timeout trees idea for minimizing onchain data when channel factory users become unresponsive
...
See also
    ...
    Ark, a protocol based on timeout trees
...
Previous Topic:Timelocks




Next Topic:Trampoline payments
...
- topics ()
- channel
factories (channel-factories)
- joinpools (joinpools)
- covenant (covenants)
- Ark, a protocol based on timeout trees (ark)
- Timelocks (timelocks)

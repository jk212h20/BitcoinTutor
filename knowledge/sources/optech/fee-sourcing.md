...
2024
  ...
  Vulnerability allowing theft from LN channels using variable endogenous fees
  More efficient fee sponsorship for exogenous fees compared favorably to endogenous fees
  ...
  Argument that frequent use of exogenous fees may put mining decentralization at risk
    ...
    An alternative to exogenous anchor outputs: endogenous fees with presigned incremental RBF bumps
...
Previous Topic:Fee sniping




Next Topic:Fee sponsorship

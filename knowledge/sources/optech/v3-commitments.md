...
2025
  ...
  Using v3 commitments to allow mobile wallets to settle channels without extra UTXOs
...
Previous Topic:Version 2 P2P transport
...
- endogenous fees (fee-sourcing)
- anchor outputs (anchor-outputs)
- CPFP (cpfp)
- minimum necessary (default-minimum-transaction-relay-feerates)
- CPFP carve-out (cpfp-carve-out)
- transaction pinning
attacks (transaction-pinning)
- cluster mempool (cluster-mempool)
- TRUC (version-3-transaction-relay)
- Package relay (package-relay)
- P2A (ephemeral-anchors)
- Sibling RBF (kindred-replace-by-fee)
- uneconomic (uneconomical-outputs)

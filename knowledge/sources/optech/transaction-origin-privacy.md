...
Primary code and documentation
  ...
  Bitcoin Wiki: Privacy—Traffic analysis
...
2023
  ...
  Replacement cycle mitigation of frequent transaction rebroadcasting with potential privacy reduction


2020

  Bitcoin Core #19109 adds a per-peer rolling bloom filter to track recent tx announcements
  Bitcoin Core #18861 only allows a peer to request a tx if it informed that peer about the tx


2019

  Transcript: ‘TxProbe: discovering Bitcoin’s network topology using orphan transactions’
  Bitcoin Core #15834 fixes a bug introduced in #14897 semi-random order for requesting transactions
  Bitcoin Core #14897 introduces a semi-random order when requesting transactions
...
Previous Topic:Transaction bloom filtering




Next Topic:Transaction pinning
...
- v2 P2P transport (v2-p2p-transport)
- Dandelion (dandelion)

...
2024
  ...
  LND #8960 adds custom channel functionality for taproot assets
...
2023
  ...
  Specifications published for taproot assets
  Update on RGB


2022

  Taro transferrable token scheme
...
Previous Topic:Channel jamming attacks




Next Topic:CLTV expiry delta
...
- topics ()
- taproot (taproot)
- Pay to Contract (P2C) (pay-to-contract-outputs)

...
Primary code and documentation
  ...
  BIP143 (No FindAndDelete)
  BIP341 (transaction digest)
  Consensus cleanup (specification)
...
2019
  ...
  Discussion of OP_CODESEPARATOR design for proposed tapscript soft fork
  Discussion about cleanup soft fork: concerns about OP_CODESEPARATOR
  Proposed consensus cleanup soft fork: prevent use of OP_CODESEPARATOR
  Consensus cleanup background: legacy transaction verification
  Should OP_CODESEPARATOR be included in future Script language upgrades?


2018

  Bitcoin Core 0.16.1 to cease relaying transactions using OP_CODESEPARATOR


See also


  Tapscript soft fork proposal
...
Previous Topic:OP_CHECKTEMPLATEVERIFY




Next Topic:Out-of-band fees

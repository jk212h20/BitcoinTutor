...
2025
  ...
  Updated ChillDKG draft for distributed key generation for FROST


2024

  BIP proposed for creating FROST scriptless threshold signatures for Bitcoin
  ChillDKG distributed key generation protocol for FROST


2023

  Idea for privacy enhanced transaction cosigning using FROST
  Experimental implementation of FROST announced


2022

  Transcripts of talks about the FROST and ROAST threshold signature schemes


2020

  Discussion about digital signatures schemes, including threshold signatures
...
Previous Topic:Testnet




Next Topic:Time warp
...
- topics ()
- scriptless multisignature (multisignature)
- tapscript (tapscript)
- taproot (taproot)

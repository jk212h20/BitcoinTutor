...
sniping. Originally implemented in Bitcoin
...
re-mined version of a previous block.  It’s also possible to implement the same protection using BIP68 nSequence
...
2022
  ...
  CoreDev.tech transcript of discussion about fees and fee sniping
  Discussion about fee sniping in relationship to block subsidy
  BDK #611 begins using anti fee sniping by default
  LDK #1531 begins using anti fee sniping for LN funding transactions
  BIPs #1269 assigns BIP326 to a recommendation for default taproot anti fee sniping
...
2018
    ...
    LND #2063 updates sweeper to use nLockTime anti fee sniping
...
Previous Topic:Fee estimation




Next Topic:Fee sourcing

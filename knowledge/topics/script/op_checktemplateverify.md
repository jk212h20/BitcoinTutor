...
slug: "op_checktemplateverify"
domain: script
difficulty: 5
source: optech
related: ["channel-factories", "vaults", "discreet-log-contracts", "adaptor-signatures", "sighash_anyprevout", "eltoo", "op_cat", "op_checksigfromstack", "pay-to-contract-outputs", "taproot", "covenants", "signet", "fee-estimation", "cpfp", "fee-sourcing", "out-of-band-fees", "acc", "op_codeseparator"]
---
